...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "259-499", label: "$259 To $499"},
      { value: "359-599", label: "$359 To $599"},
      { value: "459-699", label: "$459 To $699"},
      { value: "559-799", label: "$559 To $799"},
      { value: "659-899", label: "$659 To $899"},
      { value: "759-999", label: "$759 To $999" },
      { value: "859-2000", label: "$859 & Above"},
    ],
  },
  {
    id: "availability",
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3 flex flex-wrap justify-center">
                {
                    menskurta.map((item,index)=><Productcard key={index} product={item}/>)
                }
                </div>
            </div>
          </section>
